...
export default function Carousel({ title, description, theme, card, button }) {
  ...
  return (
    <div className={`container mx-auto rounded-2xl flex flex-col items-center font-tenorite py-12 lg:py-20 relative ${styles.bg}`}>
